...
public class EmployeeRecordGUI {
    ...
    public EmployeeRecordGUI() {
        frame = new JFrame("Employee Records");
        ...
        tabbedPane.addTab("Add Employees", addEmployeePanel);
        ...
        tabbedPane.addTab("Count Employees", countEmployeePanel);
        ...
        tabbedPane.addChangeListener(e -> {
            if (tabbedPane.getSelectedIndex() == 1) { // Assuming the "View Employees" tab is at index 1
                updateDisplayTable();
            }
        });

        tabbedPane.addChangeListener(e -> {
            if (tabbedPane.getSelectedIndex() == 2) { // Assuming the "Modify Employees" tab is at index 2
                clearDisplayTable();
            }
        });
    ...
    private JPanel createAddEmployeePanel() {
        ...
        c.gridx = 0;
        c.gridy = 0;
        panel.add(createStyledLabel("First Name", labelFont), c);
        c.gridx = 1;
        panel.add(createStyledTextField(firstNameField, fieldFont), c);

        c.gridx = 0;
        c.gridy = 1;
        panel.add(createStyledLabel("Last Name", labelFont), c);
        c.gridx = 1;
        panel.add(createStyledTextField(lastNameField, fieldFont), c);

        c.gridx = 0;
        c.gridy = 2;
        panel.add(createStyledLabel("Age", labelFont), c);
        c.gridx = 1;
        panel.add(createStyledTextField(ageField, fieldFont), c);

        c.gridx = 0;
        c.gridy = 3;
        panel.add(createStyledLabel("Basic Salary", labelFont), c);
        c.gridx = 1;
        panel.add(createStyledTextField(basicSalaryField, fieldFont), c);

        c.gridx = 0;
        c.gridy = 4;
        panel.add(createStyledLabel("Department", labelFont), c);
        c.gridx = 1;
        panel.add(createStyledTextField(departmentField, fieldFont), c);

        c.gridx = 0;
        c.gridy = 5;
        panel.add(createStyledLabel("Date of Joining (DD-MM-YYYY)", labelFont), c);
        c.gridx = 1;
        panel.add(createStyledTextField(dateOfJoiningField, fieldFont), c);

        c.gridx = 0;
        c.gridy = 6;
        panel.add(createStyledLabel("Address", labelFont), c);
        c.gridx = 1;
        panel.add(createStyledTextField(addressField, fieldFont), c);

        c.gridx = 0;
        c.gridy = 7;
        panel.add(createStyledLabel("City", labelFont), c);
        c.gridx = 1;
        panel.add(createStyledTextField(cityField, fieldFont), c);

        c.gridx = 0;
        c.gridy = 8;
        panel.add(createStyledLabel("Phone Number", labelFont), c);
        c.gridx = 1;
        panel.add(createStyledTextField(phoneNumberField, fieldFont), c);
    ...
    private JTextField createStyledTextField(JTextField textField, Font font) {
        ...
        textField.setBorder(BorderFactory.createLineBorder(Color.GRAY)); // Add a border
        return textField;
    }
